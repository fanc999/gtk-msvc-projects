...
!ifdef SKIA
CAIRO_ADDITIONAL_FEATURES = $(CAIRO_ADDITIONAL_FEATURES) CAIRO_HAS_SKIA_SURFACE
CAIRO_MAKE_OPTIONS = $(CAIRO_MAKE_OPTIONS) SKIA^=$(SKIA)
# TODO: Investigate on building.  Skia does not seem to have version releases.
!endif
...
CAIRO_SCRIPT_CFLAGS = /I$(CFG)\$(PLAT)\cairo-script $(CAIRO_INCLUDES)
