...
#ifdef _MSC_VER
# ifdef IN_LIBGETTEXTPO
#  define LIBGETTEXTPO_DLL_EXPORTED __declspec(dllexport)
# else
#  define LIBGETTEXTPO_DLL_EXPORTED __declspec(dllimport)
# endif
#else
# define LIBGETTEXTPO_DLL_EXPORTED
#endif
...
extern LIBGETTEXTPO_DLL_EXPORTED po_file_t po_file_create (void);
...
extern LIBGETTEXTPO_DLL_EXPORTED const char * const * po_file_domains (po_file_t file);
...
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_file_domain_header (po_file_t file, const char *domain);

/* Return the value of a field in a header entry.
   The return value is either a freshly allocated string, to be freed by the
   caller, or NULL.  */
extern LIBGETTEXTPO_DLL_EXPORTED char * po_header_field (const char *header, const char *field);
...
extern LIBGETTEXTPO_DLL_EXPORTED char * po_header_set_field (const char *header, const char *field, const char *value);
...
/* Create an iterator for traversing a domain of a PO file in memory.
   The domain NULL denotes the default domain.  */
extern LIBGETTEXTPO_DLL_EXPORTED po_message_iterator_t po_message_iterator (po_file_t file, const char *domain);

/* Free an iterator.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_iterator_free (po_message_iterator_t iterator);

/* Return the next message, and advance the iterator.
   Return NULL at the end of the message list.  */
extern LIBGETTEXTPO_DLL_EXPORTED po_message_t po_next_message (po_message_iterator_t iterator);
...
/* Insert a message in a PO file in memory, in the domain and at the position
   ...
   inserted message.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_insert (po_message_iterator_t iterator, po_message_t message);
...
extern LIBGETTEXTPO_DLL_EXPORTED po_message_t po_message_create (void);

/* Return the context of a message, or NULL for a message not restricted to a
   context.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_msgctxt (po_message_t message);

/* Change the context of a message. NULL means a message not restricted to a
   context.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_msgctxt (po_message_t message, const char *msgctxt);

/* Return the msgid (untranslated English string) of a message.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_msgid (po_message_t message);

/* Change the msgid (untranslated English string) of a message.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_msgid (po_message_t message, const char *msgid);

/* Return the msgid_plural (untranslated English plural string) of a message,
   or NULL for a message without plural.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_msgid_plural (po_message_t message);

/* Change the msgid_plural (untranslated English plural string) of a message.
   NULL means a message without plural.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_msgid_plural (po_message_t message, const char *msgid_plural);

/* Return the msgstr (translation) of a message.
   Return the empty string for an untranslated message.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_msgstr (po_message_t message);

/* Change the msgstr (translation) of a message.
   Use an empty string to denote an untranslated message.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_msgstr (po_message_t message, const char *msgstr);
...
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_msgstr_plural (po_message_t message, int index);
...
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_msgstr_plural (po_message_t message, int index, const char *msgstr);

/* Return the comments for a message.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_comments (po_message_t message);

/* Change the comments for a message.
   comments should be a multiline string, ending in a newline, or empty.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_comments (po_message_t message, const char *comments);

/* Return the extracted comments for a message.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_extracted_comments (po_message_t message);

/* Change the extracted comments for a message.
   comments should be a multiline string, ending in a newline, or empty.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_extracted_comments (po_message_t message, const char *comments);

/* Return the i-th file position for a message, or NULL if i is out of
   range.  */
extern LIBGETTEXTPO_DLL_EXPORTED po_filepos_t po_message_filepos (po_message_t message, int i);

/* Remove the i-th file position from a message.
   The indices of all following file positions for the message are decremented
   by one.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_remove_filepos (po_message_t message, int i);
...
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_add_filepos (po_message_t message, const char *file, size_t start_line);

/* Return the previous context of a message, or NULL for none.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_prev_msgctxt (po_message_t message);

/* Change the previous context of a message.  NULL is allowed.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_prev_msgctxt (po_message_t message, const char *prev_msgctxt);

/* Return the previous msgid (untranslated English string) of a message, or
   NULL for none.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_prev_msgid (po_message_t message);

/* Change the previous msgid (untranslated English string) of a message.
   NULL is allowed.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_prev_msgid (po_message_t message, const char *prev_msgid);

/* Return the previous msgid_plural (untranslated English plural string) of a
   message, or NULL for none.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_message_prev_msgid_plural (po_message_t message);

/* Change the previous msgid_plural (untranslated English plural string) of a
   message.  NULL is allowed.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_prev_msgid_plural (po_message_t message, const char *prev_msgid_plural);

/* Return true if the message is marked obsolete.  */
extern LIBGETTEXTPO_DLL_EXPORTED int po_message_is_obsolete (po_message_t message);

/* Change the obsolete mark of a message.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_obsolete (po_message_t message, int obsolete);

/* Return true if the message is marked fuzzy.  */
extern LIBGETTEXTPO_DLL_EXPORTED int po_message_is_fuzzy (po_message_t message);

/* Change the fuzzy mark of a message.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_fuzzy (po_message_t message, int fuzzy);

/* Return true if the message is marked as being a format string of the given
   type (e.g. "c-format").  */
extern LIBGETTEXTPO_DLL_EXPORTED int po_message_is_format (po_message_t message, const char *format_type);

/* Change the format string mark for a given type of a message.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_format (po_message_t message, const char *format_type, /*bool*/int value);

/* If a numeric range of a message is set, return true and store the minimum
   and maximum value in *MINP and *MAXP.  */
extern LIBGETTEXTPO_DLL_EXPORTED int po_message_is_range (po_message_t message, int *minp, int *maxp);
...
/* Change the numeric range of a message.  MIN and MAX must be non-negative,
   ...
   message.  */
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_set_range (po_message_t message, int min, int max);


/* =========================== po_filepos_t API ============================ */

/* Return the file name.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_filepos_file (po_filepos_t filepos);

/* Return the line number where the string starts, or (size_t)(-1) if no line
   number is available.  */
extern LIBGETTEXTPO_DLL_EXPORTED size_t po_filepos_start_line (po_filepos_t filepos);


/* ============================ Format type API ============================= */

/* Return a NULL terminated array of the supported format types.  */
extern LIBGETTEXTPO_DLL_EXPORTED const char * const * po_format_list (void);
...
extern LIBGETTEXTPO_DLL_EXPORTED const char * po_format_pretty_name (const char *format_type);
...
extern LIBGETTEXTPO_DLL_EXPORTED void po_file_check_all (po_file_t file, po_xerror_handler_t handler);
...
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_check_all (po_message_t message, po_message_iterator_t iterator, po_xerror_handler_t handler);
...
extern LIBGETTEXTPO_DLL_EXPORTED void po_message_check_format (po_message_t message, po_xerror_handler_t handler);
