...
# if !(defined _GL_GRGL_STDDEF_H && defined _GL_STDDEF_WINT_T)
#  ifdef __need_wint_t
...
#  if (0 \
       && (!defined _GL_GRGL_STDDEF_H || defined _GL_STDDEF_WINT_T))
#   undef NULL
#   ifdef __cplusplus
