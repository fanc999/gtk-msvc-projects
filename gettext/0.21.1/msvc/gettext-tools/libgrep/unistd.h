...
#if !defined _GL_GRGL_UNISTD_H && !defined _GL_INCLUDING_WINSOCK2_H
#define _GL_GRGL_UNISTD_H
...
#if 0 && 00 && !defined GTPO_CONFIG_H && !defined _GL_SYSTEM_GETOPT
...
#if 0 && 1
# if !defined _GL_GRGL_SYS_SOCKET_H
#  if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#   undef socket
...
#  endif
# endif
# if !defined _GL_GRGL_SYS_SELECT_H
#  if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#   undef select
