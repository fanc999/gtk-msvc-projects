...
#include "C:\Program Files (x86)\Microsoft Visual Studio 11.0\VC\INCLUDE\math.h"
...
#  if 0 && __GNUC__ >= 4 && (!defined __clang__ || __has_builtin (__builtin_isnanf))
...
#  endif
#  if 0 && __GNUC__ >= 4 && (!defined __clang__ || __has_builtin (__builtin_isnanl))
